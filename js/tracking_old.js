...
function followupQuestions(per_value, over_value) {
  ...
  // '<p>What is the unit of your input? ' +
  // '<input type="text" class="form-control form-inline" id="input-unit"></p>' +
  '<p>What is the possible input(s)?' +
  // '<input type="text" class="form-control form-inline" id="input-intervals"></p>' +
  '<select class="form-control form-inline select-intervaltype">' +
