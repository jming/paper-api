function tree(){
  ...
  initialize = function(){
    // d3.select("#flowchart-canvas").append("div").attr('id','navdiv');
    ...
    // d3.select("#flowchart-canvas").select("svg").append('g').attr('transform',function(){ return 'translate('+tree.incX+','+tree.incY+')';})
